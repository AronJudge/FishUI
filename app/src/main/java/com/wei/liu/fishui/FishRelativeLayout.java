...
public class FishRelativeLayout extends RelativeLayout {
    ...
    private com.wei.liu.fishui.FishDrawable fishDrawable;
    ...
    private void init(Context context) {
        ...
        fishDrawable = new com.wei.liu.fishui.FishDrawable();
...
//        objectAnimator2.start();
        ...
        PointF controlPoint = fishDrawable.calculatePoint(fishMiddle,
                com.wei.liu.fishui.FishDrawable.HEAD_RADIUS * 1.6f, angle / 2 + delta);
